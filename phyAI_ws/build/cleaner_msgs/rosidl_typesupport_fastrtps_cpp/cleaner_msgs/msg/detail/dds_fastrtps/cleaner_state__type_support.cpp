...
#include "cleaner_msgs/msg/detail/cleaner_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cleaner_msgs::msg::CleanerState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cleaner_msgs::msg::CleanerState & ros_message)
{
  // Member: stamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cleaner_msgs
max_serialized_size_CleanerState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cleaner_msgs::msg::CleanerState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cleaner_msgs::msg::CleanerState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cleaner_msgs::msg::CleanerState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CleanerState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cleaner_msgs::msg::CleanerState *>(
...
static size_t _CleanerState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CleanerState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CleanerState__callbacks = {
  "cleaner_msgs::msg",
  "CleanerState",
...
static rosidl_message_type_support_t _CleanerState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CleanerState__callbacks,
...
{
  return &cleaner_msgs::msg::typesupport_fastrtps_cpp::_CleanerState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cleaner_msgs, msg, CleanerState)() {
  return &cleaner_msgs::msg::typesupport_fastrtps_cpp::_CleanerState__handle;
}
