...
#include "cleaner_msgs/msg/detail/cleaner_state__rosidl_typesupport_fastrtps_c.h"
...
using _CleanerState__ros_msg_type = cleaner_msgs__msg__CleanerState;

static bool _CleanerState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CleanerState__ros_msg_type * ros_message = static_cast<const _CleanerState__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
...
static bool _CleanerState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _CleanerState__ros_msg_type * ros_message = static_cast<_CleanerState__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_cleaner_msgs__msg__CleanerState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CleanerState__ros_msg_type * ros_message = static_cast<const _CleanerState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CleanerState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cleaner_msgs__msg__CleanerState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cleaner_msgs
size_t max_serialized_size_cleaner_msgs__msg__CleanerState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cleaner_msgs__msg__CleanerState;
    is_plain =
      (
...
static size_t _CleanerState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_cleaner_msgs__msg__CleanerState(
...
static message_type_support_callbacks_t __callbacks_CleanerState = {
  "cleaner_msgs::msg",
  "CleanerState",
  _CleanerState__cdr_serialize,
  _CleanerState__cdr_deserialize,
  _CleanerState__get_serialized_size,
  _CleanerState__max_serialized_size
};

static rosidl_message_type_support_t _CleanerState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CleanerState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cleaner_msgs, msg, CleanerState)() {
  return &_CleanerState__type_support;
}
