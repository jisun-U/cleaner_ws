...
#ifndef CLEANER_MSGS__MSG__DETAIL__CLEANER_STATE__STRUCT_HPP_
#define CLEANER_MSGS__MSG__DETAIL__CLEANER_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__cleaner_msgs__msg__CleanerState __attribute__((deprecated))
#else
# define DEPRECATED__cleaner_msgs__msg__CleanerState __declspec(deprecated)
#endif
...
struct CleanerState_
{
  using Type = CleanerState_<ContainerAllocator>;

  explicit CleanerState_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : stamp(_init)
  {
  ...
  explicit CleanerState_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : stamp(_alloc, _init),
    system_state(_alloc),
    pose_frame(_alloc),
    vision_json(_alloc),
  ...
  // pointer types
  using RawPtr =
    cleaner_msgs::msg::CleanerState_<ContainerAllocator> *;
  using ConstRawPtr =
    const cleaner_msgs::msg::CleanerState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      cleaner_msgs::msg::CleanerState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__cleaner_msgs__msg__CleanerState
    std::shared_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__cleaner_msgs__msg__CleanerState
    std::shared_ptr<cleaner_msgs::msg::CleanerState_<ContainerAllocator> const>
  ...
  bool operator==(const CleanerState_ & other) const
  {
...
using CleanerState =
  cleaner_msgs::msg::CleanerState_<std::allocator<void>>;
...
#endif  // CLEANER_MSGS__MSG__DETAIL__CLEANER_STATE__STRUCT_HPP_
