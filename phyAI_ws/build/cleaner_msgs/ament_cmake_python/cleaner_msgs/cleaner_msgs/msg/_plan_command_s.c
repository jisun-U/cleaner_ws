...
bool cleaner_msgs__msg__plan_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cleaner_msgs.msg._plan_command.PlanCommand", full_classname_dest, 42) == 0);
  }
  cleaner_msgs__msg__PlanCommand * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of PlanCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cleaner_msgs.msg._plan_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanCommand");
