...
bool cleaner_msgs__msg__cleaner_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cleaner_msgs.msg._cleaner_state.CleanerState", full_classname_dest, 44) == 0);
  }
  cleaner_msgs__msg__CleanerState * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of CleanerState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cleaner_msgs.msg._cleaner_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CleanerState");
