...
struct DetectionArray_
{
  ...
  using _detections_type =
    std::vector<yolov8_msgs::msg::Detection_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<yolov8_msgs::msg::Detection_<ContainerAllocator>>>;
  ...
  Type & set__detections(
    const std::vector<yolov8_msgs::msg::Detection_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<yolov8_msgs::msg::Detection_<ContainerAllocator>>> & _arg)
  {
