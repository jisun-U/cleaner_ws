...
{
  new (message_memory) cleaner_msgs::msg::PlanCommand(_init);
}

void PlanCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cleaner_msgs::msg::PlanCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PlanCommand_message_member_array[3] = {
  {
    ...
    offsetof(cleaner_msgs::msg::PlanCommand, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cleaner_msgs::msg::PlanCommand, mission_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cleaner_msgs::msg::PlanCommand, plan_json),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PlanCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(cleaner_msgs::msg::PlanCommand),
...
{
  return &::cleaner_msgs::msg::rosidl_typesupport_introspection_cpp::PlanCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cleaner_msgs, msg, PlanCommand)() {
  return &::cleaner_msgs::msg::rosidl_typesupport_introspection_cpp::PlanCommand_message_type_support_handle;
}
