...
class ActionGeneratorNode(Node):
    ...
    def get_action_sequence_from_gpt(self, user_input):
        ...
        try:
            system_prompt = """
You are an intelligent command interpreter for an autonomous targeting robot system (ATS). Your task is to convert user voice commands into structured JSON action sequences.
